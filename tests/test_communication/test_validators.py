...
class MessagesTest(unittest.TestCase):
    ...
    def test_create_messages(self):
        ...
        FromResponseRequestMessage({'id': u'id', 'url': u'http://example.com', "from_response_request": {}})
    ...
    def test_from_response_request_params(self):
        fields = {'id': u'id', 'url': u'http://example.com'}

        self.assertRaisesRegexp(MessageError, 'Required field: from_response_request', FromResponseRequestMessage.from_dict, fields)
